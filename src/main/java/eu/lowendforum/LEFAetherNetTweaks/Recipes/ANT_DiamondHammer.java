...
public class ANT_DiamondHammer {
    public static void makeRecipe(Plugin triggerPlugin){
        //Make item and key
        NamespacedKey key = new NamespacedKey(triggerPlugin, "ANT_DiamondHammer");
        ItemStack outputItem = new ItemStack(Material.DIAMOND_PICKAXE, 1);
        ...
        outputItemMeta.displayName(Component.text("Diamond Hammer"));
